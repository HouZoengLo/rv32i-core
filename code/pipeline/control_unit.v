...
module control_unit (
    ...
    always @(*) begin
        rf_raddr_rs1    =   (   instruction[6:0]==7'b0110011
                            ||  instruction[6:0]==7'b0010011
                            ||  instruction[6:0]==7'b0000011
                            ||  instruction[6:0]==7'b0100011
                            ||  instruction[6:0]==7'b1100011
                            ||  instruction[6:0]==7'b1100111)? instruction[19:15]:5'b0;

        rf_raddr_rs2    =   (   instruction[6:0]==7'b0110011
                            ||  instruction[6:0]==7'b0100011
                            ||  instruction[6:0]==7'b1100011)? instruction[24:20]:5'b0;
